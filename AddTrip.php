...
<div id = "frm1" div class="container">
  <label for="enterMyOwn"> <b> Date: </b></label>
  ...
  <label for="enterMyOwn"> <b> Rating: </b></label>
  <input type="text" id="service" placeholder="Enter Rating" name="service">

  <label for="enterMyOwn"> <b> Cost: </b></label>
  <input type="text" id="service" placeholder="Enter Cost" name="service">
