...
<body>
    ...
    <div class="container" >
      ...
      //  echo ' <button onclick="window.location.href = 'QuickStats.php'"> Quick Stats </button>';
        echo "<a href='ViewTrips.php?newUSRID=" . $myID . "' ><button> View Trips</button></a>";
        echo "<a href='AddTrip.php?usrid=" . $newUSRID . "' ><button>Add Trip</button></a>";
        echo "<a href='QuickStats.php?usrid=" . $newUSRID . "' ><button>Quick Stats</button></a>";
